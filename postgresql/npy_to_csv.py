...
dataList = np.load("/home/jingyi/spatial-lsm/data/data_{}_{}_hr.npy".format(info, n))
...
with open("/home/jingyi/spatial-lsm/data/data_{}_{}_hr_random".format(info, n), 'w') as csvfile:
